...
final class SQLiteEventRepositoryTests: XCTestCase {
    ...
    func test_readEventsAt_returnsEvents() throws {
        try database.insertEvent(entityId: "entity", entityType: "type", name: "name", jsonDetails: "{}", actor: "actor", version: 1, position: 1)
    ...
    func test_readEventsAt_returnsOnlyEventsAtTheIndicatedPosition() throws {
        try database.insertEvent(entityId: "entity", entityType: "type", name: "name", jsonDetails: "{}", actor: "actor", version: 0, position: 0)
        try database.insertEvent(entityId: "entity", entityType: "type", name: "name", jsonDetails: "{}", actor: "actor", version: 1, position: 1)
        try database.insertEvent(entityId: "entity", entityType: "type", name: "name", jsonDetails: "{}", actor: "actor", version: 2, position: 2)
